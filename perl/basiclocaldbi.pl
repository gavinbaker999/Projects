...
#      unixsocket => 'endhousesoftware.x10hosting.com/website/var/lib/mysql.sock',
	  hostname => 'endhousesoftware.x10hosting.com',   # Default use UNIX socket
      database => 'endhousesoftware_com',
      user     => 'endhousesoftware',
      password => 'links',
#	  timeout  => 3000,
	  debug	   => 1
  );
